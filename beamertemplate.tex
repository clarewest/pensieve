...
\begin{frame}{Figure-on-one-side slide example, with changing figure}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \centering
      \only<1>{\includegraphics[width=1\textwidth]{2OKQA.png}}
      \only<2>{\includegraphics[width=1\textwidth]{1SFS_A.png}}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
      \setlength{\itemsep}{1em}
        ...
        \begin{itemize}
          ...
          \item Very nice 
        \end{itemize}
        \only<1>{\item This figure will change on the next slide, but the slide number will be the same}
        \only<2>{\item Great! Now I don't have to duplicate slides or scare the audience with the slide count}
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
